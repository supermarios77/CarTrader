...
export function LandingCta() {
  return (
    <section className="relative overflow-hidden rounded-[3rem] border border-cyan-500/20 bg-gradient-to-br from-cyan-500/10 to-teal-500/10 p-10 sm:p-16">
      ...
      <div className="relative text-center">
        ...
        <div className="flex flex-col justify-center gap-4 sm:flex-row">
          <Button className="rounded-xl bg-gradient-to-r from-cyan-500 to-teal-600 px-10 py-6 font-semibold text-white hover:opacity-90">
            Post Your Car
          </Button>
          <Button
            variant="outline"
